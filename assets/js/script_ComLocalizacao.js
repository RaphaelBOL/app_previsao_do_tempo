...
async function buscarPrevisaoHorariaPorCoordenadas(lat, lon) {
  let dadosPrevisaoHoraria = await fetch(
  ...
  if (navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(
      (position) => {
        ...
        buscarPrevisaoHorariaPorCoordenadas(lat, lon);
      },
      (error) => {
...
// Ocultar o info-container e previsao-wrapper ao iniciar a página e carregar clima local
